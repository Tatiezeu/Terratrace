      ...
      <CardContent>
        <div className="space-y-4">
          <div className="font-mono text-sm bg-white dark:bg-slate-900 rounded-lg p-3 border border-border shadow-sm">
            ...
            <span className="text-muted-foreground">-</span>
            <span className="text-blue-600 dark:text-blue-400 font-bold">P8798</span>
          </div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-muted-foreground border-l-2 border-blue-100 pl-2">
                <span className="font-bold text-foreground">Sub portion No:</span> Sub portion number generated by TerraTrace
              </div>
            </div>
          </div>
